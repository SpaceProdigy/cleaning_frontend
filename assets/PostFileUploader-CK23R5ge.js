import{s as g,B as b,j as e,i as J,a as r,u as T,b as D,Y as K,a8 as d,P as Y,N as te,T as ne,a5 as O,k as H,b4 as $,W as ie,f as se,r as B,I as re,a0 as z,ab as N,ac as V,g as oe,b5 as ae}from"./index-VRjfB3Or.js";import{d as le,i as ce}from"./CloudUpload-DNXG-YZ9.js";import{e as w}from"./errorMessages-CzWlP_QR.js";import{u as pe,C as G}from"./index.esm-C2hpFCo6.js";import{F as de,I as ue}from"./ImageNotSupported-vrt7yV1Q.js";import{M as me,r as he,U as ge}from"./UniversalReactMarkdown-CM6r6ag9.js";import{F as C,I as R,a as I,O as _}from"./OutlinedInput-Ilw7ROUx.js";import{S as xe,M as fe}from"./Select-xWJOb_Sv.js";import{d as be}from"./Close-C2mmMyaN.js";import{A as ye}from"./index-C1D0ZcF1.js";const X="/cleaning_frontend/assets/hero-yK5kWOTn.png",Ae=g(b)`
  width: 100%;
  height: 100%;
...
- List`},Le=/^(https?:\/\/)?(www\.)?(youtube\.com\/(?:[^\n\s]+\/\S+|\S+)?|vimeo\.com\/\d+)(?:[?&][^&]*\S+)?$/i,we={ua:"Посібник з оформлення",en:"Formatting Guide"};function ee({handleUpload:c,handleFileChange:x,handlePosterChange:u,files:m,setFiles:k,defaultCategory:f}){var S,W,q,t,p;const{register:y,handleSubmit:M,formState:{errors:s},control:U}=pe(),i=T(D),h=T(K),F=i==="ua"?`
# Заголовок
**Жирний текст**
_Курсив_
[Посилання](https://example.com)
